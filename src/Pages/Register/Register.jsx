                    ...
                    <div className="max-w-6xl flex items-center gap-32">
                        ...
                        <div className="w-full max-w-xl p-4 rounded-md shadow sm:p-8 bg-gray-800 dark:text-gray-100" >
                            ...
                            <p className="text-sm text-center dark:text-gray-400">Already have account?
                                <Link to='/login' rel="noopener noreferrer" className="focus:underline hover:underline ml-5 text-red-500">Sign in here</Link>
                            </p>
                            <form onSubmit={handleRegister} action="" className="space-y-8 mt-10">
                                <div className="space-y-4" >
                                   ...
                                   <div className="space-y-2 flex-1" >
                                    ...
                                    <div className="space-y-2 flex-1" >
                                        <div className="flex justify-between" >
                                            <label name="bloodGroup" className="text-sm">Blood Group*</label>
                                        </div>
                                        <select required className=" select select-error w-full px-3 py-2 border rounded-md dark:border-red-500 dark:bg-gray-800 dark:text-gray-100 ">
                                   ...
                                   <div className="space-y-2 flex-1" >
                                        <div className="flex justify-between" >
                                            <label name="confirmPassword" className="text-sm">District*</label>
                                        </div>
                                        <select required className="select select-error w-full px-3 py-2 border rounded-md dark:border-red-500 dark:bg-gray-800 dark:text-gray-100 ">
                                    ...
                                    <div className="space-y-2 flex-1" >
                                        <div className="flex justify-between" >
                                            <label name="confirmPassword" className="text-sm">Upazila*</label>
                                        </div>
                                        <select required className="select select-error w-full px-3 py-2 border rounded-md dark:bg-gray-800 dark:text-gray-100 ">
